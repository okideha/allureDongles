 ...
 */
final class Version20200420155237 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE CommandRows (id INT AUTO_INCREMENT NOT NULL, id_product_id INT NOT NULL, id_command_id INT NOT NULL, qte INT NOT NULL, pu DOUBLE PRECISION NOT NULL, tva INT NOT NULL, INDEX IDX_1A733E13E00EE68D (id_product_id), INDEX IDX_1A733E13966BE84D (id_command_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE CommandRows ADD CONSTRAINT FK_1A733E13966BE84D FOREIGN KEY (id_command_id) REFERENCES Commands (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE CommandRows DROP FOREIGN KEY FK_1A733E13966BE84D');
